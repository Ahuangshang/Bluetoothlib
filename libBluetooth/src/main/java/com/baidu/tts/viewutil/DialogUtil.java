package com.baidu.tts.viewutil;
...
public class DialogUtil implements View.OnClickListener {
    ...
    private DialogBtnClickListener leftBtnClickListenter, rightDialogBtnClickListener;
    ...
    private View buttonTwoBtnLayout, buttonOneBtnLayout;
    ...
    public DialogUtil setLeftBtnClickListener(DialogBtnClickListener leftDialogBtnClickListener) {
        this.leftBtnClickListenter = leftDialogBtnClickListener;
        return this;
    }

    public DialogUtil setRightDialogBtnClickListener(DialogBtnClickListener rightDialogBtnClickListener) {
        this.rightDialogBtnClickListener = rightDialogBtnClickListener;
        return this;
    }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.button_left_btn) {
            ...
            if (rightDialogBtnClickListener != null) {
                rightDialogBtnClickListener.btnClick();
            }
